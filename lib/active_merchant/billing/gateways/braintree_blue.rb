...
raise "Need braintree gem >= 4.23.0. Run `gem install braintree --version '~>4.23'` to get the correct version." unless Braintree::Version::Major == 4 && Braintree::Version::Minor >= 23
